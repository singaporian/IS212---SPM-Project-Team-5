    ...
    <section class="hero d-flex align-items-center">
      <div class="me-4" style="flex:1">
        ...
        <div class="d-flex gap-2 mt-3">
          <router-link class="btn btn-accent btn-lg" to="/requests/new">Create Request</router-link>
    ...
    <div class="row gx-4">
      ...
      <div class="col-lg-4">
        <div class="card quick-actions mb-3">
          <div class="card-body">
            <h6>Quick Actions</h6>
            <router-link class="btn btn-outline-primary btn-sm w-100 mb-2" to="/requests/new">Start Draft</router-link>
